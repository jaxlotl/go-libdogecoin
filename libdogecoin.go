...
#cgo LDFLAGS: -L${SRCDIR}/.libs -L${SRCDIR}/.libs/lib -L${SRCDIR}/depends/x86_64-pc-linux-gnu/lib -ldogecoin -levent_core -levent -lpthread -lsecp256k1 -lsecp256k1_precomputed -lm -Wl,-rpath=${SRCDIR}/.libs
#include "address.h"
